...
\begin{figure}[ht!]
	...
	\caption{Logarithmische Barrierefunktionen für verschiedene Gewichtungsfaktoren $\mu$}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=200pt]{Abbildungen/apexTrajektory.png}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=350pt]{Abbildungen/MPCSimulation.png}
...
Für das dynamische Fahrzeugmodell wurde eine minimale Rundenzeit 3.05 s gemessen.  Die damit erhaltene maximale Querbeschleunigung ist deutlich größer als die des kinematischen Models. 
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=250pt]{Abbildungen/quadraticCostFunction.png}
	\caption{Platzhalter}
