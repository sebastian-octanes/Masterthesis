...
\begin{figure}[ht!]
	\includegraphics[width=350pt]{Abbildungen/mpcParadigm.jpg}
...
Um dieses Verfahren umzusetzen wird die die Positivitätsbedingungen $x \geq 0$ der Standardform durch einen logarithmische Strafterm $-\mu \ln x_i $  ersetzt und in die Kostenfunktion integriert. Die daraus resultierende Funktion wird als Barrierefunktion  $B(x,\mu)$ bezeichnet und ist definiert als \\
...
Der Algorithmus benötigt die Ableitungsmatrix der Barrierefunktion. Die Berechnung dieser wird durch eine automatische Ableitung realisiert welche im Kapitel \ref{julia} genauer ausgeführt ist. 
