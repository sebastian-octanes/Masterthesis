...
Mit dem idealen Prädiktionshorizon und der maximalen Querbeschleunigung können nun die idealen Parameter für die Kostenfunktion gesucht werden. Betrachtet werden die Rundenzeiten, ob das Rennauto den Kurs verlassen hat (abbruch) und wie sich die Rechenzeit verändert.

\subsection{E-Funktion}



Weiß noch nicht genau wie ich das hier evaluieren soll. Beta max hat einen großen Einfluss, aber auch a und b und max speed. Maximale Zeit oder zurück gelegter Weg außerhalb des Kurses? 2D oder 3D plots? ... 
...
\subsubsection{Trajektorienplanung}
